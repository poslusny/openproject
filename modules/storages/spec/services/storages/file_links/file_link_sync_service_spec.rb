...
RSpec.describe Storages::FileLinkSyncService, type: :model do
  ...
  let(:storage_one) { create(:nextcloud_storage_configured, host: "https://host-1.example.org") }
  let(:storage_two) { create(:nextcloud_storage_configured, host: "https://host-2.example.org") }
